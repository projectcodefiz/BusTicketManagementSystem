...
//             CHECK IF THE FIELDS ARE EMPTY
            if (availableB_busID.getText().isEmpty()
                ...
                alert.setContentText("Silakan isi semua kolom yang kosong");
                alert.showAndWait();
...
//                CHECK IF THE BUS ID IS ALREADY EXIST
                ...
                if (result.next()) {
                    ...
                    alert.setTitle("Pesan Error");
                    alert.setHeaderText(null);
                    alert.setContentText("Bus ID: " + availableB_busID.getText() + " sudah ada!");
                    alert.showAndWait();
    ...
    public void availableBusUpdate() {
        ...
        try {
            ...
            if (availableB_busID.getText().isEmpty()
                ...
                alert.setTitle("Pesan Error");
                alert.setHeaderText(null);
                alert.setContentText("Silakan pilih itemnya terlebih dahulu");
                alert.showAndWait();
                ...
                alert.setHeaderText(null);
                alert.setContentText("Apakah Anda yakin ingin MEMPERBARUI Bus ID: " + availableB_busID.getText() + "?");
    ...
    public void availableBusDelete(){
        ...
        try{
            ...
            if (availableB_busID.getText().isEmpty()
                ...
                alert.setTitle("Pesan Konfirmasi");
                alert.setHeaderText(null);
                alert.setContentText("Apakah Anda yakin ingin MENGHAPUS Bus ID: " + availableB_busID.getText() + "?");
...
//    NOW LETS CREATE TABLE FOR customer
    ...
    private String[] genderL = {"Pria","Wanita","Lain-lain"};
...
//            CHECK IF EMPTY
            if(bookingTicket_sci_firstName.getText().isEmpty()
                ...
                alert.setTitle("Pesan Error");
                alert.setHeaderText(null);
                alert.setContentText("Silakan pilih informasinya terlebih dahulu");
                alert.showAndWait();
    ...
    public void bookingTicketReceipt(){
        ...
        try{
            ...
            if(totalP > 0){
                ...
                JasperDesign jDesign = JRXmlLoader.load("D:\\NETBEANS\\BusManagementSystem-main\\busTicketBookingManagementSystem\\src\\busticketbookingmanagementsystem\\report.jrxml");
