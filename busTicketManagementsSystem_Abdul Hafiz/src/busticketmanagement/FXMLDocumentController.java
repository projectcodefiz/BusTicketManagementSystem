...
public class FXMLDocumentController implements Initializable {
    ...
    public void loginBtn() {
        ...
        if (si_username.getText().isEmpty() || si_password.getText().isEmpty()) {
            ...
            alert.setContentText("Nama Pengguna/Kata Sandi Salah");
            alert.showAndWait();
        } else {
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    stage.setTitle("Sistem Manajemen Pemesanan Tiket Bus");
        ...
        if (su_username.getText().isEmpty() || su_password.getText().isEmpty()
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    alert.setTitle("Pesan Error");
                    alert.setHeaderText(null);
                    alert.setContentText(su_username.getText() + " sudah digunakan");
                    alert.showAndWait();
                } else if (su_password.getText().length() < 8) {
                    alert = new Alert(AlertType.ERROR);
                    alert.setTitle("Pesan Error");
                    alert.setHeaderText(null);
                    alert.setContentText("Kata Sandi Tidak Valid, setidaknya diperlukan 8 karakter");
                    alert.showAndWait();
                } else {
                    ...
                    alert.setTitle("Pesan Informasi");
                    alert.setHeaderText(null);
                    alert.setContentText("Pendaftaran akun berhasil!");
                    alert.showAndWait();
    ...
    private String[] questionList = {"Apa warna kesukaanmu?", "Apa makanan favoritmu?", "Berapa tanggal lahirmu?", "Siapa nama Ibumu?", "Siapa nama Ayahmu?", "Dimanakan kamu mencari ilmu?"};
        ...
        if (fp_username.getText().isEmpty() || fp_question.getSelectionModel().getSelectedItem() == null
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    alert.setTitle("Pesan Error");
                    alert.setHeaderText(null);
                    alert.setContentText("Informasi yang Salah");
                    alert.showAndWait();
                }
        ...
        if (np_newPassword.getText().isEmpty() || np_confirmPassword.getText().isEmpty()) {
            ...
            if (np_newPassword.getText().equals(np_confirmPassword.getText())) {
                ...
                try {
                    ...
                    alert.setTitle("Pesan Informasi");
                    alert.setHeaderText(null);
                    alert.setContentText("Berhasil mengubah Kata Sandi!");
                    alert.showAndWait();
